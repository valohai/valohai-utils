...
def test_get_input_paths(use_test_config_dir):
    assert get_input_path("single_image") == "/valohai/inputs/single_image/Example.jpg"
    assert (
        get_input_path("single_image", "unused_default") == "/valohai/inputs/single_image/Example.jpg"
    )
